...
{style_instruction}
Be clear, accurate, and preserve important information.

Text:
{content}

Provide ONLY the summary text without any prefixes like "Here is a summary" or "Summary:". Start directly with the content.
"""
    ...
    def run(self, documents: List[Document]) -> Dict[str, Any]:
        ...
        for idx, doc in enumerate(documents):
            try:
                ...
                logger.error(f"Error summarizing document {idx}: {type(e).__name__}: {str(e)}")
